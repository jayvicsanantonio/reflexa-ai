/**
 * Minimalist hero component for toolbar popup
 * Provides quick access to start reflection
 */
...
/**
 * Compact hero component for the popup
 */
export const PopupHero: React.FC<PopupHeroProps> = ({ onReflectClick }) => {
  const bgGradient =
