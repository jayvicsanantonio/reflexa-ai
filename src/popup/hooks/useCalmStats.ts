...
import type { Reflection, CalmStats } from '../../types';

/**
 * Hook for deriving calm stats from reflections
 * Pure computation with no side effects - uses useMemo for performance
 *
 * @param reflections - Array of reflections to derive stats from
 * @returns CalmStats object with computed statistics
 */
export function useCalmStats(reflections: Reflection[]): CalmStats {
  return useMemo<CalmStats>(() => {
